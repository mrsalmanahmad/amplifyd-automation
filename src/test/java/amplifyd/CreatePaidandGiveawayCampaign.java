...
public class CreatePaidandGiveawayCampaign {
    public static void main(String[] args) {

    }
    public static void createpaidandgiveawaycampagin() throws MalformedURLException, InterruptedException {
        ...
        MobileElement giveawaycampaignbox = (MobileElement) Amplifydtest.driver.findElement(By.id("com.logicon.amplifyd.debug:id/give_way_chk_box"));
        giveawaycampaignbox.click();
        ...
        camptitle.sendKeys("Auto Paid & Giveaway Campaign "+ dateobj);
